...
const ServicePage = () => {
  ...
  return (
    <div className="relative w-full flex flex-col items-center">
      ...
      {/* Footer Section */}
      <div className="absolute bottom-4 right-4 text-xs md:text-sm lg:text-base bg-black text-white py-2 px-4 flex flex-col md:flex-row gap-2 md:gap-4 items-center md:items-start">
